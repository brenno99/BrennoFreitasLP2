...
namespace Matrizes_CompeticaoNatacao2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int qtd_nadadores = int.Parse(Console.ReadLine());
            string[] nadadores = new string[qtd_nadadores];
            string nome = "";

            Console.WriteLine("Digite a quantidade de provas: ");
            int qtd_provas = int.Parse(Console.ReadLine());
            double[,] provas = new double[qtd_nadadores, qtd_provas];
            int numero_prova = 0;
            double tempo = 0;
            ...
            for (int coluna = 0; coluna < qtd_provas; coluna++)
            {
                for (int linha = 0; linha < qtd_nadadores; linha++)
                {
